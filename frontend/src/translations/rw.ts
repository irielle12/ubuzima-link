export const rw: Record<string, string> = {
  ...
  "Patient will be texted their reference number automatically once this device is back online": "Umurwayi azohererezwa nimero y'inkomoko mu butumwa igihe iyi terefone izaboneka internet",
  ...
  "Patient Texted Successfully": "Umurwayi Yohererejwe Ubutumwa",
  "The patient received their reference number by SMS.": "Umurwayi yakiriye nimero y'inkomoko mu butumwa bugufi.",
  "SMS Delivery Failed": "Kohereza Ubutumwa Byanze",
  "The patient may not have received the reference number by text. Please inform them directly.": "Umurwayi ashobora kuba atarakiriye nimero y'inkomoko mu butumwa. Mumumenyeshe ubwanyu.",
