...
const FACILITIES = [
  { code: "HP002", name: "Nyamirambo Health Post", type: "HEALTH_POST", district: "Nyarugenge", sector: "Nyamirambo", phone: "0788100002", email: "nyamirambo.hp@ubuzima.rw" },
  { code: "HC002", name: "Remera Health Center", type: "HEALTH_CENTER", district: "Gasabo", sector: "Remera", phone: "0788100003", email: "remera.hc@ubuzima.rw" },
  { code: "HC003", name: "Nyanza Health Center", type: "HEALTH_CENTER", district: "Nyanza", sector: "Busasamana", phone: "0788100004", email: "nyanza.hc@ubuzima.rw" },
  { code: "DH002", name: "Muhima District Hospital", type: "DISTRICT_HOSPITAL", district: "Nyarugenge", sector: "Muhima", phone: "0788100005", email: "muhima.dh@ubuzima.rw" },
];

// facilityId is resolved by code at seed time (see FACILITY_CODE_BY_ROLE_KEY below)
const USERS = [
  { staffId: "NURSE002", firstName: "Emmanuel", lastName: "Nshimiyimana", email: "emmanuel.nshimiyimana@ubuzima.rw", role: "nurse", facilityCode: "HP002" },
  { staffId: "NURSE003", firstName: "Solange", lastName: "Uwimana", email: "solange.uwimana@ubuzima.rw", role: "nurse", facilityCode: "HC001" },
  { staffId: "NURSE004", firstName: "Eric", lastName: "Habimana", email: "eric.habimana@ubuzima.rw", role: "nurse", facilityCode: "HC002" },
  { staffId: "NURSE005", firstName: "Claudine", lastName: "Mukeshimana", email: "claudine.mukeshimana@ubuzima.rw", role: "nurse", facilityCode: "HC003" },
  ...
  { staffId: "NURSE007", firstName: "Alphonsine", lastName: "Nyiraneza", email: "alphonsine.nyiraneza@ubuzima.rw", role: "nurse", facilityCode: "HP002" },
  { staffId: "CLIN002", firstName: "Dr. Jean Bosco", lastName: "Nsengimana", email: "jeanbosco.nsengimana@kacyiru.rw", role: "clinician", facilityCode: "DH001" },
  { staffId: "CLIN003", firstName: "Dr. Immaculee", lastName: "Mukamurenzi", email: "immaculee.mukamurenzi@muhima.rw", role: "clinician", facilityCode: "DH002" },
  { staffId: "CLIN004", firstName: "Dr. Patrick", lastName: "Ndayisenga", email: "patrick.ndayisenga@muhima.rw", role: "clinician", facilityCode: "DH002" },
...
const REFERRALS = [
  { referralNumber: "REF-DEMO-001", patientKey: "p15", sourceCode: "HC002", destCode: "DH001", chiefComplaint: "Fell from a tree, right arm pain and swelling", diagnosis: "Suspected forearm fracture", urgency: "Urgent", vitalBp: "110/70", vitalHeartRate: "92", vitalTemperature: "36.8", vitalRespiratoryRate: "20", workflowStatus: "Pending Hospital Review", createdAt: daysAgo(1, 8, 0), events: [createdEvent(1, "Eric Habimana (NURSE004)", "Remera Health Center"), submittedEvent(1, "Eric Habimana (NURSE004)", "Remera Health Center")] },
  { referralNumber: "REF-DEMO-002", patientKey: "p14", sourceCode: "HP002", destCode: "DH002", chiefComplaint: "Progressive confusion and weakness on left side since this morning", diagnosis: "Suspected stroke", urgency: "Emergency", vitalBp: "168/104", vitalHeartRate: "98", vitalTemperature: "37.1", vitalRespiratoryRate: "22", workflowStatus: "Closed", treatmentStatus: "Admitted", hospitalNotes: "CT scan confirmed ischemic stroke. Admitted to the stroke unit for thrombolysis evaluation and ongoing monitoring.", createdAt: daysAgo(0, 7, 30), arrivedAt: daysAgo(0, 9, 30), hospitalViewedAt: daysAgo(0, 9, 15), feedbackAt: daysAgo(0, 15, 0), events: [createdEvent(0, "Emmanuel Nshimiyimana (NURSE002)", "Nyamirambo Health Post"), submittedEvent(0, "Emmanuel Nshimiyimana (NURSE002)", "Nyamirambo Health Post"), arrivedEvent(0, "Marked arrived by Dr. Immaculee Mukamurenzi (CLIN003) at Muhima District Hospital"), closedEvent(0, "Closed with feedback by Dr. Immaculee Mukamurenzi (CLIN003) at Muhima District Hospital")] },

  // -- Pending Hospital Review (submitted, waiting) --
  { referralNumber: "REF-DEMO-003", patientKey: "p13", sourceCode: "HP001", destCode: "DH001", chiefComplaint: "Severe right lower abdominal pain, fever, vomiting", diagnosis: "Suspected appendicitis", urgency: "Urgent", vitalBp: "118/76", vitalHeartRate: "104", vitalTemperature: "38.6", vitalRespiratoryRate: "24", workflowStatus: "Pending Hospital Review", createdAt: daysAgo(2, 8, 15), events: [createdEvent(2, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post"), submittedEvent(2, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post")] },
  { referralNumber: "REF-DEMO-004", patientKey: "p12", sourceCode: "HC003", destCode: "DH002", chiefComplaint: "Persistent vomiting and diarrhea for 3 days, unable to keep fluids down", diagnosis: "Acute gastroenteritis with moderate dehydration", urgency: "Urgent", vitalBp: "96/60", vitalHeartRate: "112", vitalTemperature: "37.9", vitalRespiratoryRate: "22", workflowStatus: "Pending Hospital Review", createdAt: daysAgo(3, 9, 0), events: [createdEvent(3, "Claudine Mukeshimana (NURSE005)", "Nyanza Health Center"), submittedEvent(3, "Claudine Mukeshimana (NURSE005)", "Nyanza Health Center")] },
  { referralNumber: "REF-DEMO-005", patientKey: "p9", sourceCode: "HC002", destCode: "DH001", chiefComplaint: "Chronic cough for 4 weeks, night sweats, weight loss", diagnosis: "Suspected pulmonary tuberculosis", urgency: "Routine", vitalBp: "112/74", vitalHeartRate: "88", vitalTemperature: "37.4", vitalRespiratoryRate: "20", workflowStatus: "Pending Hospital Review", createdAt: daysAgo(5, 8, 30), events: [createdEvent(5, "Eric Habimana (NURSE004)", "Remera Health Center"), submittedEvent(5, "Eric Habimana (NURSE004)", "Remera Health Center")] },
  { referralNumber: "REF-DEMO-006", patientKey: "p6", sourceCode: "HP002", destCode: "DH002", chiefComplaint: "Second-degree burns to left hand and forearm from cooking accident", diagnosis: "Second-degree burns, approx. 8% BSA", urgency: "Urgent", vitalBp: "122/80", vitalHeartRate: "96", vitalTemperature: "37.0", vitalRespiratoryRate: "18", workflowStatus: "Pending Hospital Review", createdAt: daysAgo(4, 10, 0), events: [createdEvent(4, "Alphonsine Nyiraneza (NURSE007)", "Nyamirambo Health Post"), submittedEvent(4, "Alphonsine Nyiraneza (NURSE007)", "Nyamirambo Health Post")] },
  { referralNumber: "REF-DEMO-007", patientKey: "p8", sourceCode: "HC002", destCode: "DH001", chiefComplaint: "28 weeks pregnant, severe headache, blurred vision, swollen feet", diagnosis: "Suspected pre-eclampsia", urgency: "Urgent", vitalBp: "156/98", vitalHeartRate: "90", vitalTemperature: "36.9", vitalRespiratoryRate: "20", workflowStatus: "Pending Hospital Review", createdAt: daysAgo(1, 13, 0), events: [createdEvent(1, "Eric Habimana (NURSE004)", "Remera Health Center"), submittedEvent(1, "Eric Habimana (NURSE004)", "Remera Health Center")] },

  // -- Arrived (accepted, patient present at hospital) --
  { referralNumber: "REF-DEMO-008", patientKey: "p1", sourceCode: "HP001", destCode: "DH001", chiefComplaint: "High fever, chills, confusion for 2 days", diagnosis: "Severe malaria with altered consciousness", urgency: "Emergency", vitalBp: "100/64", vitalHeartRate: "118", vitalTemperature: "39.8", vitalRespiratoryRate: "28", workflowStatus: "Arrived", createdAt: daysAgo(6, 7, 45), arrivedAt: daysAgo(6, 11, 30), hospitalViewedAt: daysAgo(6, 10, 0), events: [createdEvent(6, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post"), submittedEvent(6, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post"), arrivedEvent(6, "Marked arrived by Dr. Amina Uwera (CLINIC001) at Kacyiru District Hospital")] },
  { referralNumber: "REF-DEMO-009", patientKey: "p4", sourceCode: "HC001", destCode: "DH001", chiefComplaint: "Sudden severe chest pain radiating to left arm, sweating", diagnosis: "Suspected acute coronary syndrome", urgency: "Emergency", vitalBp: "88/56", vitalHeartRate: "128", vitalTemperature: "36.6", vitalRespiratoryRate: "26", workflowStatus: "Arrived", createdAt: daysAgo(8, 8, 0), arrivedAt: daysAgo(8, 10, 45), hospitalViewedAt: daysAgo(8, 9, 30), events: [createdEvent(8, "Solange Uwimana (NURSE003)", "Masaka Health Center"), submittedEvent(8, "Solange Uwimana (NURSE003)", "Masaka Health Center"), arrivedEvent(8, "Marked arrived by Dr. Jean Bosco Nsengimana (CLIN002) at Kacyiru District Hospital")] },
  { referralNumber: "REF-DEMO-010", patientKey: "p7", sourceCode: "HP002", destCode: "DH002", chiefComplaint: "Motorbike accident, deformity and swelling of right thigh, unable to bear weight", diagnosis: "Suspected fractured femur", urgency: "Emergency", vitalBp: "104/68", vitalHeartRate: "110", vitalTemperature: "37.2", vitalRespiratoryRate: "24", workflowStatus: "Arrived", createdAt: daysAgo(10, 16, 0), arrivedAt: daysAgo(10, 18, 15), hospitalViewedAt: daysAgo(10, 17, 0), events: [createdEvent(10, "Emmanuel Nshimiyimana (NURSE002)", "Nyamirambo Health Post"), submittedEvent(10, "Emmanuel Nshimiyimana (NURSE002)", "Nyamirambo Health Post"), arrivedEvent(10, "Marked arrived by Dr. Immaculee Mukamurenzi (CLIN003) at Muhima District Hospital")] },
  { referralNumber: "REF-DEMO-011", patientKey: "p11", sourceCode: "HC003", destCode: "DH002", chiefComplaint: "Known diabetic, drowsy and breathing rapidly, fruity breath odor", diagnosis: "Suspected diabetic ketoacidosis", urgency: "Emergency", vitalBp: "98/60", vitalHeartRate: "116", vitalTemperature: "37.6", vitalRespiratoryRate: "30", workflowStatus: "Arrived", createdAt: daysAgo(7, 6, 30), arrivedAt: daysAgo(7, 9, 0), hospitalViewedAt: daysAgo(7, 8, 0), events: [createdEvent(7, "Claudine Mukeshimana (NURSE005)", "Nyanza Health Center"), submittedEvent(7, "Claudine Mukeshimana (NURSE005)", "Nyanza Health Center"), arrivedEvent(7, "Marked arrived by Dr. Patrick Ndayisenga (CLIN004) at Muhima District Hospital")] },

  { referralNumber: "REF-DEMO-012", patientKey: "p5", sourceCode: "HC001", destCode: "DH001", chiefComplaint: "Chronic knee pain, worse on stairs, no swelling or fever", diagnosis: "Suspected osteoarthritis", urgency: "Routine", vitalBp: "134/84", vitalHeartRate: "78", vitalTemperature: "36.6", vitalRespiratoryRate: "18", workflowStatus: "Closed", treatmentStatus: "Patient Seen & Treated", hospitalNotes: "Reviewed in outpatient clinic. Advised routine orthopedic follow-up and home exercises; no admission required.", createdAt: daysAgo(14, 9, 0), arrivedAt: daysAgo(14, 11, 0), hospitalViewedAt: daysAgo(14, 10, 45), feedbackAt: daysAgo(14, 14, 0), events: [createdEvent(14, "Solange Uwimana (NURSE003)", "Masaka Health Center"), submittedEvent(14, "Solange Uwimana (NURSE003)", "Masaka Health Center"), arrivedEvent(14, "Marked arrived by Dr. Amina Uwera (CLINIC001) at Kacyiru District Hospital"), closedEvent(14, "Closed with feedback by Dr. Amina Uwera (CLINIC001) at Kacyiru District Hospital")] },
  { referralNumber: "REF-DEMO-013", patientKey: "p2", sourceCode: "HP001", destCode: "DH001", chiefComplaint: "Mild seasonal cough and runny nose, no fever", diagnosis: "Suspected common cold", urgency: "Routine", vitalBp: "116/72", vitalHeartRate: "80", vitalTemperature: "36.9", vitalRespiratoryRate: "18", workflowStatus: "Closed", treatmentStatus: "Patient Seen & Treated", hospitalNotes: "Assessed and managed symptomatically as an outpatient. No admission required.", createdAt: daysAgo(11, 10, 30), arrivedAt: daysAgo(11, 12, 15), hospitalViewedAt: daysAgo(11, 12, 0), feedbackAt: daysAgo(11, 15, 0), events: [createdEvent(11, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post"), submittedEvent(11, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post"), arrivedEvent(11, "Marked arrived by Dr. Jean Bosco Nsengimana (CLIN002) at Kacyiru District Hospital"), closedEvent(11, "Closed with feedback by Dr. Jean Bosco Nsengimana (CLIN002) at Kacyiru District Hospital")] },

  // -- Closed (with feedback) --
  { referralNumber: "REF-DEMO-014", patientKey: "p3", sourceCode: "HP001", destCode: "DH001", chiefComplaint: "3-month-old, poor feeding, fast breathing, chest indrawing", diagnosis: "Severe pneumonia", urgency: "Emergency", vitalBp: "-", vitalHeartRate: "148", vitalTemperature: "38.9", vitalRespiratoryRate: "58", workflowStatus: "Closed", treatmentStatus: "Admitted", hospitalNotes: "Started on IV antibiotics and oxygen support. Responding well, expected discharge in 3-4 days.", createdAt: daysAgo(20, 7, 0), arrivedAt: daysAgo(20, 9, 30), hospitalViewedAt: daysAgo(20, 8, 30), feedbackAt: daysAgo(17, 14, 0), events: [createdEvent(20, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post"), submittedEvent(20, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post"), arrivedEvent(20, "Marked arrived by Dr. Amina Uwera (CLINIC001) at Kacyiru District Hospital"), closedEvent(17, "Closed with feedback by Dr. Amina Uwera (CLINIC001) at Kacyiru District Hospital")] },
  { referralNumber: "REF-DEMO-015", patientKey: "p10", sourceCode: "HC002", destCode: "DH001", chiefComplaint: "Fell off a swing, deformity of left wrist, crying in pain", diagnosis: "Suspected wrist fracture", urgency: "Urgent", vitalBp: "-", vitalHeartRate: "104", vitalTemperature: "36.8", vitalRespiratoryRate: "22", workflowStatus: "Closed", treatmentStatus: "Patient Seen & Treated", hospitalNotes: "X-ray confirmed greenstick fracture. Cast applied, follow-up in 2 weeks.", createdAt: daysAgo(16, 9, 30), arrivedAt: daysAgo(16, 11, 0), hospitalViewedAt: daysAgo(16, 10, 15), feedbackAt: daysAgo(16, 13, 0), events: [createdEvent(16, "Eric Habimana (NURSE004)", "Remera Health Center"), submittedEvent(16, "Eric Habimana (NURSE004)", "Remera Health Center"), arrivedEvent(16, "Marked arrived by Dr. Jean Bosco Nsengimana (CLIN002) at Kacyiru District Hospital"), closedEvent(16, "Closed with feedback by Dr. Jean Bosco Nsengimana (CLIN002) at Kacyiru District Hospital")] },
  { referralNumber: "REF-DEMO-016", patientKey: "p9", sourceCode: "HC002", destCode: "DH002", chiefComplaint: "In active labor, prolonged second stage, fetal distress signs", diagnosis: "Obstructed labor", urgency: "Emergency", vitalBp: "128/82", vitalHeartRate: "102", vitalTemperature: "37.3", vitalRespiratoryRate: "24", workflowStatus: "Closed", treatmentStatus: "Referred Onward", hospitalNotes: "Emergency C-section performed, mother and baby stable. Transferred to maternity ward for recovery.", createdAt: daysAgo(23, 3, 0), arrivedAt: daysAgo(23, 4, 30), hospitalViewedAt: daysAgo(23, 3, 45), feedbackAt: daysAgo(22, 10, 0), events: [createdEvent(23, "Eric Habimana (NURSE004)", "Remera Health Center"), submittedEvent(23, "Eric Habimana (NURSE004)", "Remera Health Center"), arrivedEvent(23, "Marked arrived by Dr. Immaculee Mukamurenzi (CLIN003) at Muhima District Hospital"), closedEvent(22, "Closed with feedback by Dr. Immaculee Mukamurenzi (CLIN003) at Muhima District Hospital")] },

  // -- Closed (without feedback / patient did not arrive) --
  { referralNumber: "REF-DEMO-017", patientKey: "p1", sourceCode: "HP001", destCode: "DH001", chiefComplaint: "Snake bite to right foot while farming, mild swelling", diagnosis: "Snake bite, monitoring for envenomation", urgency: "Emergency", vitalBp: "118/76", vitalHeartRate: "94", vitalTemperature: "36.9", vitalRespiratoryRate: "20", workflowStatus: "Closed", treatmentStatus: "Patient Did Not Arrive", hospitalNotes: "No record of patient arrival within 24 hours of referral. Health post following up.", createdAt: daysAgo(19, 14, 0), feedbackAt: daysAgo(18, 9, 0), events: [createdEvent(19, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post"), submittedEvent(19, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post"), closedEvent(18, "Closed without feedback by Dr. Amina Uwera (CLINIC001) at Kacyiru District Hospital")] },
  { referralNumber: "REF-DEMO-018", patientKey: "p4", sourceCode: "HC001", destCode: "DH001", chiefComplaint: "Elderly patient, fell at home, unable to stand, hip pain", diagnosis: "Suspected hip fracture", urgency: "Urgent", vitalBp: "142/88", vitalHeartRate: "92", vitalTemperature: "36.7", vitalRespiratoryRate: "20", workflowStatus: "Closed", treatmentStatus: "Admitted", hospitalNotes: "Confirmed neck-of-femur fracture on X-ray. Scheduled for surgical fixation, admitted to orthopedic ward.", createdAt: daysAgo(13, 8, 0), arrivedAt: daysAgo(13, 10, 30), hospitalViewedAt: daysAgo(13, 9, 15), feedbackAt: daysAgo(12, 16, 0), events: [createdEvent(13, "Solange Uwimana (NURSE003)", "Masaka Health Center"), submittedEvent(13, "Solange Uwimana (NURSE003)", "Masaka Health Center"), arrivedEvent(13, "Marked arrived by Dr. Amina Uwera (CLINIC001) at Kacyiru District Hospital"), closedEvent(12, "Closed with feedback by Dr. Amina Uwera (CLINIC001) at Kacyiru District Hospital")] },

  // -- This week (keeps each facility's "Referrals This Week" stat non-zero) --
  { referralNumber: "REF-DEMO-019", patientKey: "p1", sourceCode: "HP001", destCode: "DH001", chiefComplaint: "Persistent fever for 6 days, headache, abdominal discomfort", diagnosis: "Suspected typhoid fever", urgency: "Routine", vitalBp: "118/74", vitalHeartRate: "86", vitalTemperature: "38.2", vitalRespiratoryRate: "18", workflowStatus: "Pending Hospital Review", createdAt: daysAgo(1, 9, 0), events: [createdEvent(1, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post"), submittedEvent(1, "Jeanne Mukamana (NURSE001)", "Kigarama Health Post")] },
  { referralNumber: "REF-DEMO-020", patientKey: "p5", sourceCode: "HC001", destCode: "DH001", chiefComplaint: "Known chronic kidney disease, increasing swelling and shortness of breath", diagnosis: "Suspected CKD progression, needs dialysis evaluation", urgency: "Urgent", vitalBp: "158/94", vitalHeartRate: "88", vitalTemperature: "36.8", vitalRespiratoryRate: "22", workflowStatus: "Arrived", createdAt: daysAgo(0, 8, 0), arrivedAt: daysAgo(0, 10, 0), hospitalViewedAt: daysAgo(0, 9, 45), events: [createdEvent(0, "Solange Uwimana (NURSE003)", "Masaka Health Center"), submittedEvent(0, "Solange Uwimana (NURSE003)", "Masaka Health Center"), arrivedEvent(0, "Marked arrived by Dr. Amina Uwera (CLINIC001) at Kacyiru District Hospital")] },
  { referralNumber: "REF-DEMO-021", patientKey: "p12", sourceCode: "HC003", destCode: "DH002", chiefComplaint: "High fever, chills, and body aches for 2 days", diagnosis: "Suspected malaria", urgency: "Urgent", vitalBp: "108/70", vitalHeartRate: "108", vitalTemperature: "39.1", vitalRespiratoryRate: "24", workflowStatus: "Pending Hospital Review", createdAt: daysAgo(1, 10, 0), events: [createdEvent(1, "Claudine Mukeshimana (NURSE005)", "Nyanza Health Center"), submittedEvent(1, "Claudine Mukeshimana (NURSE005)", "Nyanza Health Center")] },
];
...
async function main() {
  ...
  const facilityIdByCode = {
    ...
    HC001: (await pool.query(`SELECT id FROM facilities WHERE code = 'HC001'`)).rows[0]?.id,
  ...
  console.log("\nClinician/Admin accounts (require email 2FA code — needs RESEND_API_KEY configured):");
  for (const u of createdUsers.filter((u) => u.role !== "nurse")) {
